...
import { FiDollarSign, FiEye, FiLayers, FiShoppingCart, FiTrendingUp } from "react-icons/fi";
      ...
      <section className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
        ...
        >
          <div className="flex items-center justify-between gap-4">
            <div>
              <p className="text-sm uppercase tracking-[0.2em] text-slate-400">Top Producto</p>
              <span className="mt-3 block max-w-[11rem] text-base font-bold leading-snug text-sky-300 sm:text-lg">
                {stats.topProductName}
              </span>
            </div>
            <span className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-slate-800 text-slate-300">
              <FiEye className="h-4 w-4" aria-hidden="true" />
              <span className="sr-only">Ver detalle</span>
            </span>
          </div>
          <p className="mt-2 text-xs text-slate-500">Producto más vendido del trimestre</p>
        </button>
      </section>
